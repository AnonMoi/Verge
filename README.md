...
本项目为 Verge 塔防游戏的**开发中版本**，仅供预览、学习和社区交流。

未经全体团队成员书面授权，**禁止任何个人或组织将本项目代码或资源用于商业用途**。禁止再分发、再许可、销售、出租或集成到商业产品中。

> 本游戏仍处于开发阶段，团队保留全部知识产权。详见 [LICENSE](./LICENSE)。
...
| 🟡 迅捷鬼影 | 70 | 快速(144) | 5金 | 12 | 已有独立美术与动画，20% 闪避逻辑待完善 |
| ⚫ 黑铁精英 | 500 | 慢速(56) | 12金 | 35 | 已有独立美术与动画，重击逻辑待完善 |
...
| 成员 | 主要责任 |
|------|---------|
| [@AnonMoi](https://github.com/AnonMoi) | 核心系统开发 & 项目架构 |
| [@GoodGuoZhi](https://github.com/GoodGuoZhi) | 角色与场景美术 |
| [@boYan223](https://github.com/boYan223) | 音效与特效 |
| [@Hzy-0313](https://github.com/Hzy-0313) | 剧情与关卡设计 |
